...
class Solution(object):
    def findCelebrity(self, n):
        ...
        若k为candidate，则0~k-1不可能是celebrity，因为肯定认识至少一个人；k+1~n-1也不可能是celebrity，因为有至少一个人（比如candidate）不认识他。
        一个合法的candidate，应该要做到不认识loop之后剩下的所有人，这样loop到最后，你就会产生一个candidate，然后做同样的验证即可。
        """
        cand = 0
        # Find the candidate.候选人是0，从1到n开始问，如果0认识其中一个，那就将那一个设置为候选人，因为名人不能认识别人。
        for i in range(1, n):
    ...
    # https://www.cnblogs.com/jimmycheng/p/7500262.html
